...
public class DChamps1BlueRightLeft extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DChamps1BlueRightLeft(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
        ...
        addCommands(
            ...
            createPathToTag(22, 0.2, -0.30, 180),
