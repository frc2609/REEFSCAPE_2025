...
public class DChamps1BlueRightRight extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DChamps1BlueRightRight(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
