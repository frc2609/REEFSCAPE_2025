...
public class DChamps1RedLeftLeft extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DChamps1RedLeftLeft(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
        ...
        addCommands(
            ...
            createPathToTag(9, 0.2, -0.30, 180),
