...
public class DChamps1RedRightRight extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DChamps1RedRightRight(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
