...
public class DChamps1RedMiddleLeft extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DChamps1RedMiddleLeft(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
        ...
        addCommands(
            ...
            createPathToTag(10, 0.2, -0.30, 180),
