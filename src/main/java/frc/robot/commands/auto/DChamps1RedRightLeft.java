...
public class DChamps1RedRightLeft extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DChamps1RedRightLeft(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
        ...
        addCommands(
            ...
            createPathToTag(11, 0.2, -0.30, 180),
