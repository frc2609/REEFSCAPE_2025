...
public class Dchamps1PIDRight extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight";
    private final AprilTagFieldLayout fieldLayout;
    
    public Dchamps1PIDRight(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
