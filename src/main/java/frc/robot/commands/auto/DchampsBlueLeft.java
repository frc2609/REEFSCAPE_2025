...
public class DchampsBlueLeft extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DchampsBlueLeft(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
        ...
        addCommands(
            ...
            new SequentialCommandGroup(                
                ...
                createPathToTag(20, 0.75, -0.8, 180),
                ...
                // First intake
                new ParallelCommandGroup(
                    createPathToTag(13, 0.5, 0.3, 0),
                    new HumanIntakeCommand(arm, gripper, elevator)
                    
                ).withTimeout(3.25),

                // Second score
                createPathToTag(19, 1, -1, 180),
                new WaitCommand(0.1),
                new ParallelCommandGroup(
                    new PIDFineAlign(true, drivetrain),
                    new ScoreL4CommandAuto(elevator, arm, gripper)
                ...
                // Third coral
                createPathToTag(19, 0.75, -0.8, 180),
                new WaitCommand(0.1),
                new ParallelCommandGroup(
                    new PIDFineAlign(true, drivetrain),
                    new ScoreL4CommandAuto(elevator, arm, gripper)
