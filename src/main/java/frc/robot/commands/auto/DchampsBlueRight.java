...
public class DchampsBlueRight extends SequentialCommandGroup {
    private final CommandSwerveDrivetrain drivetrain;
    private final String limelightName = "limelight-intake";
    private final AprilTagFieldLayout fieldLayout;
    
    public DchampsBlueRight(CommandSwerveDrivetrain drivetrain, Elevator elevator, Arm arm, Gripper gripper) {
        ...
        addCommands(
            ...
            new SequentialCommandGroup(                
                ...
                createPathToTag(22, 0.75, -0.8, 180),
                ...
                // First intake
                new ParallelCommandGroup(
                    createPathToTag(12, 0.5, 0.3, 0),
                    new HumanIntakeCommand(arm, gripper, elevator)
                    
                ).withTimeout(3.25),

                // Second score
                createPathToTag(17, 1, -1, 180),
                new WaitCommand(0.1),
                new ParallelCommandGroup(
                    new PIDFineAlign(true, drivetrain),
                    new ScoreL4CommandAuto(elevator, arm, gripper)
                ...
                // Third coral
                createPathToTag(17, 0.75, -0.8, 180),
                new WaitCommand(0.1),
                new ParallelCommandGroup(
                    new PIDFineAlign(true, drivetrain),
                    new ScoreL4CommandAuto(elevator, arm, gripper)
