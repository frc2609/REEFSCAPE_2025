...
public class ScoreL4KnockAlgaeL2Command extends SequentialCommandGroup{

    public ScoreL4KnockAlgaeL2Command(Elevator elevator, Arm arm, Gripper gripper, Trigger shootTrigger, Trigger confirmTrigger, Trigger confirm2Trigger){
        addCommands(
