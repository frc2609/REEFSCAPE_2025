...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(49.317).withKI(0).withKD(0.28442)
        .withKS(0.2076).withKV(2.2708).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.14856).withKI(0).withKD(0)
        .withKS(0.17327).withKV(0.123);
    ...
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(1.41);//5.41
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.0673828125);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.180908203125);
